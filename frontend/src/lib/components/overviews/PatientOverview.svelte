...
<div class="dashboard-container">
    <div class="header-section">
        <h1 class="dashboard-title">Ihre Termine auf einen Blick</h1>
    ...
    {:else}
        <EmptyState
            ...
            message="Buchen Sie Ihren ersten Termin oder setzen Sie sich auf die Warteliste – wir benachrichtigen Sie, sobald ein Slot frei wird."
            buttonText="Termin jetzt buchen"
            buttonHref="/buchen"
            variant="turquoise"
        />
    {/if}
